...
export function HemBand({
  ...
  if (style === 'rib') {
    return (
      <g data-garment-part="hem" data-construction-kind="hem" data-construction-style="rib" data-rib="true">
        <path
...
export function PocketSet({
  ...
  if (kind === 'hoodie' && style === 'kangaroo') {
    return (
      <g data-garment-part="kangaroo_pocket" data-construction-kind="pocket" data-construction-style="kangaroo" data-flat-pocket="true">
        <path
  ...
  if (kind === 'hoodie' && style === 'patch') {
    return (
      <g data-garment-part="patch_pockets" data-construction-kind="pocket" data-construction-style="patch" data-flat-pocket="true">
        <path d="M200 360 L252 360 C258 360 262 364 262 370 L262 424 C262 432 254 438 246 438 L206 438 C198 438 192 432 192 424 L192 370 C192 364 196 360 200 360 Z" fill={fill} stroke={stitch} strokeWidth="1.4" opacity="0.7" />
        <path d="M308 360 L360 360 C366 360 370 364 370 370 L370 424 C370 432 362 438 354 438 L314 438 C306 438 300 432 300 424 L300 370 C300 364 304 360 308 360 Z" fill={fill} stroke={stitch} strokeWidth="1.4" opacity="0.7" />
      </g>
    )
  }
  ...
  if (kind === 'jacket') {
    if (style === 'patch') {
      return (
        <g data-garment-part="jacket_pockets" data-construction-kind="pocket" data-construction-style="patch" data-flat-pocket="true">
          <path d="M178 392 L234 392 C240 392 244 396 244 402 L244 458 C244 466 236 472 228 472 L184 472 C176 472 170 466 170 458 L170 402 C170 396 174 392 178 392 Z" fill={fill} stroke={stitch} strokeWidth="1.4" opacity="0.72" />
          <path d="M326 392 L382 392 C388 392 392 396 392 402 L392 458 C392 466 384 472 376 472 L332 472 C324 472 318 466 318 458 L318 402 C318 396 322 392 326 392 Z" fill={fill} stroke={stitch} strokeWidth="1.4" opacity="0.72" />
        </g>
      )
    }
    if (style === 'welt') {
      return (
        <g data-garment-part="jacket_pockets" data-construction-kind="pocket" data-construction-style="welt" data-flat-pocket="true">
          <path d="M178 406 L246 406 L244 418 L176 418 Z" fill={fill} stroke={stitch} strokeWidth="0.8" />
          <path d="M314 406 L382 406 L384 418 L316 418 Z" fill={fill} stroke={stitch} strokeWidth="0.8" />
        </g>
      )
    }
    return (
  ...
  if (kind === 'cargo') {
    return (
      <g data-garment-part="cargo_pockets" data-construction-kind="pocket" data-construction-style="cargo" data-construction-slot="cargo" data-flat-pocket="true">
        <path d="M178 252 L228 252 C234 252 238 256 238 262 L238 328 C238 336 230 342 222 342 L184 342 C176 342 170 336 170 328 L170 262 C170 256 174 252 178 252 Z" fill={fill} stroke={stitch} strokeWidth="1.6" opacity="0.78" />
        <path d="M332 252 L382 252 C388 252 392 256 392 262 L392 328 C392 336 384 342 376 342 L338 342 C330 342 324 336 324 328 L324 262 C324 256 328 252 332 252 Z" fill={fill} stroke={stitch} strokeWidth="1.6" opacity="0.78" />
  ...
  if (style === 'welt') {
    return (
      <g data-garment-part="front_pockets" data-construction-kind="pocket" data-construction-style="welt" data-construction-slot="front" data-flat-pocket="true">
  ...
  return (
    <g data-garment-part="front_pockets" data-construction-kind="pocket" data-construction-style={style} data-construction-slot="front" data-flat-pocket="true">
